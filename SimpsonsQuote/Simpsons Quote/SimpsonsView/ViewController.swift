...
final class ViewController: UIViewController {
    ...
    @objc func buttonTap() {
        DispatchQueue.main.async {
            ...
            self.quoteLabel.text = "'\(self.simpsonsQuote.first?.quote ?? "TRY AGAİN")'"
            let url = URL(string: self.simpsonsQuote.first?.image ?? "https://serif-mete.online/wp-content/uploads/2023/03/pikachu-minecraft.gif")
